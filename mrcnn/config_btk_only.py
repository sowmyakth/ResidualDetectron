...
class Config(object):
    ...
    BACKBONE = "resnet101"
    # Backbone must be one from "resnet41", "resnet50", "resnet101"
    ...
    # Skip P2 in RPN feature map. If true then RPN_ANCHOR_SCALES  and
    # BACKBONE_STRIDES must have only 4 values
    SKIP_P2_RPN = False
    ...
    RPN_ANCHOR_STRIDE = 1
    # Improve performance by limiting number of proposals
    RPN_PRE_NMS_LIMIT = 500
